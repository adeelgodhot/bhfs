...
trait FromToDecimal
{
    ...
    private function getExtremeValues(FilterSetting $filterSetting, $facets, $currencyRate = 0)
    {
    ...
    private function getConfig($attrType)
    {
        ...
        if ((string)$filterSetting->getDisplayMode() === (string)DisplayMode::MODE_SLIDER ||
            ...
            $currencySymbol = $this->getCurrencySymbol($filterSetting);
            $currencyPosition = $this->getCurrencyPosition($filterSetting);
    ...
    /**
     * @param FilterSetting $filterSetting
     * @return string
     */
    private function getCurrencySymbol(FilterSetting $filterSetting)
    {
     ...
     * @return string
     */
    private function getCurrencyPosition(FilterSetting $filterSetting)
    {
     ...
     * @return string
     */
    private function getTemplateForSlider(FilterSetting $filterSetting)
    {
        $labelPosition = $this->getCurrencyPosition($filterSetting);
        $labelUnit = $this->getCurrencySymbol($filterSetting);

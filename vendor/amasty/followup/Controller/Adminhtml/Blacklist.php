...
abstract class Blacklist extends \Magento\Backend\App\Action
{
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Amasty_Followup::followup_blacklist');
    }
    ...
    {
        $this->_coreRegistry->register(RegistryConstants::CURRENT_AMASTY_AMFOLLOWUP_BLACKLIST, $blacklist);

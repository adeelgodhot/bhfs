...
class SavePlugin
{
    const AMASTY_APPLE_LOGIN_KEY = 'amasty/login/apple';
    const SIX_MOUNTHS = 15552000;
    const AMSOCIALLOGIN_APPLE_API_SECRET = 'amsociallogin/apple/api_secret';
    const AMSOCIALLOGIN_APPLE_SECRET_EXP_DATE = 'amsociallogin/apple/secret_exp_date';

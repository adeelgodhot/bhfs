...
use Amasty\ShopbyBase\Setup\Operation;
...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var Operation\AddIndexes
     */
    private $addIndexes;

    public function __construct(
        \Amasty\ShopbyBase\Helper\Data $helper,
        Operation\AddLabelPosition $addLabelPosition,
        Operation\AddImageAlt $addImageAlt,
        Operation\AddIndexes $addIndexes
    ) {
        $this->helper = $helper;
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($version, '2.13.13', '<')) {
            $this->addIndexes->execute($setup);
        }
    ...
    {
        $table = $setup->getTable(FilterSettingRepositoryInterface::TABLE);

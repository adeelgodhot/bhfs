...
class SageHelper extends AbstractHelper
{
    ...
    {
        $config3Dsecure = $this->scopeConfig->getValue('payment/magenest_sagepay/apply_3d_secure',ScopeInterface::SCOPE_STORE);
        if ($disable3DSecure) {
            return "Disable";
        } else {
    ...
    {
        $config3DsecureV2 = $this->scopeConfig->getValue('payment/magenest_sagepay/enable_3ds2',ScopeInterface::SCOPE_WEBSITE);
        return $config3DsecureV2;
    }

    public function getIsApplyCvcCheck()
    {
        return $this->scopeConfig->getValue('payment/magenest_sagepay/apply_cvc_check',ScopeInterface::SCOPE_STORE);
    }
...
//
    ...
    public function activeMoto()
    {
        return $this->scopeConfig->getValue(
            'payment/magenest_sagepay/active_moto',ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        $mode = $this->scopeConfig->getValue('payment/magenest_sagepay/test',ScopeInterface::SCOPE_WEBSITE);
        if ($mode == 1) {
    ...
    {
        return $this->scopeConfig->getValue(
            'payment/magenest_sagepay_form/test_encrypted_password',ScopeInterface::SCOPE_WEBSITE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'payment/magenest_sagepay_form/live_encrypted_password', ScopeInterface::SCOPE_WEBSITE
        );
    }
    ...
    public function getSageApiConfigArray()
    {
        ...
        $browerJSEnable = $this->scopeConfig->getValue('payment/magenest_sagepay/browser_javascript_enabled',ScopeInterface::SCOPE_WEBSITE);
...
// A default is value of 0 is used if this parameter is not included in this properties file
    ...
    public function getTransactionDetail($transactionId, $order = null)
    {
        ...
        $userName = $this->scopeConfig->getValue('payment/magenest_sagepay/user',ScopeInterface::SCOPE_WEBSITE);
        $password = $this->scopeConfig->getValue('payment/magenest_sagepay/password',ScopeInterface::SCOPE_WEBSITE);
...
//
    ...
    {
        return $this->scopeConfig->getValue('payment/magenest_sagepay_server/payment_profile',ScopeInterface::SCOPE_STORE);
    }
    ...
    {
        return $this->scopeConfig->getValue('payment/magenest_sagepay_paypal/billing_agreement',ScopeInterface::SCOPE_STORE);
    }

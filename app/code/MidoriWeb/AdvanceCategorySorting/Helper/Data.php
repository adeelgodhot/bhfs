...
namespace MidoriWeb\AdvanceCategorySorting\Helper;

/**
 * Class Data
 * @package MidoriWeb\AdvanceCategorySorting\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getConfigValue($group, $field, $storeId = null)
    {
        ...
        return $this->scopeConfig->getValue(
            'midoriweb_advance_category_sorting/' . $group . '/' . $field,
    ...
    /**
     * Check if MidoriWeb_LayeredNavigation module is enabled
     *
     * @return mixed
     */
    ...
    {
        if (
            $this->isModuleEnabled('MidoriWeb_LayeredNavigation') &&
            $this->isOutputEnabled('MidoriWeb_LayeredNavigation')
        ) {
            return $this->scopeConfig->getValue(
                'midoriweb_layerednavigation/general/ajax',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                $this->getStoreId()
            );
        }
    ...
    public function isSortByEnabledOnDesktop($storeId = null) {
        return $this->scopeConfig->getValue('midoriweb_advance_category_sorting/design_settings/display_sort_by_desktop', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function isSortByEnabledOnMobile($storeId = null) {
        return $this->scopeConfig->getValue('midoriweb_advance_category_sorting/design_settings/display_sort_by_mobile', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
    }

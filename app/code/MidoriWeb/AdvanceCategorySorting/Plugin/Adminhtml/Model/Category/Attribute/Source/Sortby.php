...
namespace MidoriWeb\AdvanceCategorySorting\Plugin\Adminhtml\Model\Category\Attribute\Source;

class Sortby
{
    /**
     * @var \MidoriWeb\AdvanceCategorySorting\Helper\Data
     */
    protected $_helper;

    /**
     * Sortby constructor.
     * @param \MidoriWeb\AdvanceCategorySorting\Helper\Data $helper
     */
    public function __construct(\MidoriWeb\AdvanceCategorySorting\Helper\Data $helper)
    {
        $this->_helper = $helper;
    }

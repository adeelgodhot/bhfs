...
namespace MidoriWeb\AdvanceCategorySorting\Plugin\Frontend\Block\Product\ProductList;

use Magento\Catalog\Model\Product\ProductList\Toolbar as ToolbarModel;
use Magento\Store\Model\StoreManagerInterface as StoreManager;
use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Framework\Registry;
use MidoriWeb\AdvanceCategorySorting\Helper\Data as Helper;
    ...
    public function beforeGetTemplateFile(
        ...
        if ($this->_helper->getConfigValue('general', 'enable')) {
            if ($template == 'Magento_Catalog::product/list/toolbar/sorter.phtml') {
                $template = 'MidoriWeb_AdvanceCategorySorting::product/list/toolbar/sorter.phtml';
            }
        }
        return [$template];
